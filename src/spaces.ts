...
const HIDDEN_TECH: Record<SubsetSize, 'hidden-single' | 'hidden-pair' | 'hidden-triple' | 'hidden-quad'> = {
  1: 'hidden-single',
  2: 'hidden-pair',
  3: 'hidden-triple',
  4: 'hidden-quad',
...
const FISH_NAME: Record<FishSize, 'Cyclops' | 'X-Wing' | 'SwordFish' | 'JellyFish'> = {
  1: 'Cyclops',
  2: 'X-Wing',
  3: 'SwordFish',
  4: 'JellyFish',
